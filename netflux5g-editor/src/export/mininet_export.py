...
class MininetExporter:
    ...
    def write_imports(self, f, categorized_nodes):
        ...
        f.write('# Order matters - try the most reliable paths first\n')
        f.write('containernet_paths = [\n')
        f.write('    f"{original_home}/containernet",  # This works better under sudo\n')
        ...
        f.write('    "/usr/local/containernet",\n')
        ...
        f.write('        else:\n')
        f.write('            print(f"✓ Containernet path already in sys.path: {path}")\n')
        f.write('        containernet_found = True\n')
        f.write('        break\n')
        f.write('    else:\n')
        f.write('        print(f"✗ Path does not exist: {path}")\n')
        f.write('\n')
        ...
        f.write('else:\n')
        f.write('    print(f"*** Current sys.path includes Containernet: {sys.path[:3]}...")\n')
        f.write('\n')
        ...
        # Always import basic Mininet components for fallback classes
        f.write('# Always import basic Mininet components for fallback classes\n')
        f.write('if not CONTAINERNET_AVAILABLE:\n')
        f.write('    try:\n')
        f.write('        from mininet.net import Mininet\n')
        f.write('        from mininet.node import Host\n')
        f.write('    except ImportError:\n')
        f.write('        print("ERROR: Cannot import basic Mininet components")\n')
        f.write('        sys.exit(1)\n')
        f.write('\n')
    ...
    def write_utility_functions(self, f):
        ...
        f.write('            filtered_kwargs = {"cls": Host}\n')
        f.write('            for key, value in kwargs.items():\n')
        f.write('                if key in ["ip", "mac", "inNamespace"]:\n')
        f.write('                    filtered_kwargs[key] = value\n')
